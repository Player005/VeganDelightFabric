...
public interface VeganDelightPlatform {
    ...
    SimpleFlowableFluid createStillFluid(SimpleFlowableFluid.Properties properties);

    SimpleFlowableFluid createFlowingFluid(SimpleFlowableFluid.Properties properties);
}
