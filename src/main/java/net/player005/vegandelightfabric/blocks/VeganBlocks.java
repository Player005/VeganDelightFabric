...
public class VeganBlocks {
    ...
    public static final Block WILD_SOYBEAN =
            register(new WildCropBlock(MobEffects.DAMAGE_BOOST, 12, BlockBehaviour.Properties.copy(Blocks.ALLIUM)), "wild_soybean", true);

    public static final Block POTTED_WILD_SOYBEAN =
            register(new FlowerPotBlock(WILD_SOYBEAN, BlockBehaviour.Properties.copy(Blocks.POTTED_ALLIUM)), "potted_wild_soybean", false);
